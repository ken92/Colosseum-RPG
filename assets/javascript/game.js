...
function btnClick(gladiator) {
    ...
    if (gladiator === player) {
        ...
        $(statusText).css("font-size", "1.5em");
        $(statusText).text(
            "You've already selected " + gladiator.name + " to represent you in the arena."
...
$(window).on("load", function () {
    ...
    // Mouseover stats
    // Spartacus
    $("#spartacusPopover").hover(function () {
        $(this).popover({
            trigger: "hover",
            placement: "top",
            title: "Spartacus:",
            content: "Hit Points: " + Spartacus.HP + " <br /> Attack Power: " + Spartacus.AP + " <br /> Counter Attack: " + Spartacus.CA,
            html: true
        }).popover('show');
    }, function () {
        $(this).popover("hide");
    ...
    // Varro
    $("#varroPopover").hover(function () {
        $(this).popover({
            trigger: "hover",
            placement: "top",
            title: "Varro:",
            content: "Hit Points: " + Varro.HP + " <br /> Attack Power: " + Varro.AP + " <br /> Counter Attack: " + Varro.CA,
            html: true
        }).popover('show');
    }, function () {
        $(this).popover("hide");
    ...
    // Ashur
    $("#ashurPopover").hover(function () {
        $(this).popover({
            trigger: "hover",
            placement: "top",
            title: "Ashur:",
            content: "Hit Points: " + Ashur.HP + " <br /> Attack Power: " + Ashur.AP + " <br /> Counter Attack: " + Ashur.CA,
            html: true
        }).popover('show');
    }, function () {
        $(this).popover("hide");
    ...
    // Crixus
    $("#crixusPopover").hover(function () {
        $(this).popover({
            trigger: "hover",
            placement: "top",
            title: "Crixus:",
            content: "Hit Points: " + Crixus.HP + " <br /> Attack Power: " + Crixus.AP + " <br /> Counter Attack: " + Crixus.CA,
            html: true
        }).popover('show');
    }, function () {
        $(this).popover("hide");
    ...
    // Gannicus
    $("#gannicusPopover").hover(function () {
        $(this).popover({
            trigger: "hover",
            placement: "top",
            title: "Gannicus:",
            content: "Hit Points: " + Gannicus.HP + " <br /> Attack Power: " + Gannicus.AP + " <br /> Counter Attack: " + Gannicus.CA,
            html: true
        }).popover('show');
    }, function () {
        $(this).popover("hide");
    ...
    // Oenomaus
    $("#oenomausPopover").hover(function () {
        $(this).popover({
            trigger: "hover",
            placement: "top",
            title: "Oenomaus:",
            content: "Hit Points: " + Oenomaus.HP + " <br /> Attack Power: " + Oenomaus.AP + " <br /> Counter Attack: " + Oenomaus.CA,
            html: true
        }).popover('show');
    }, function () {
        $(this).popover("hide");
